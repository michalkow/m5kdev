...
export function createWorkflowTables(references: { users: { id: AnySQLiteColumn } } = { users }) {
...
const workflowTables = createWorkflowTables();

export const workflows = workflowTables.workflows;
